...
LINE_MIN_SPEED="${RK_LINE_MIN_SPEED:-0.22}"
LINE_BASE_SPEED="${RK_LINE_BASE_SPEED:-0.25}"
LINE_MID_SPEED="${RK_LINE_MID_SPEED:-0.23}"
LINE_SLOW_SPEED="${RK_LINE_SLOW_SPEED:-0.22}"
SHORT_LOST_LINEAR_SPEED="${RK_SHORT_LOST_LINEAR_SPEED:-0.22}"
SEARCH_LINEAR_SPEED="${RK_SEARCH_LINEAR_SPEED:-0.22}"
BRIDGE_MAX_LINEAR_X="${RK_GO2_BRIDGE_MAX_LINEAR_X:-$LINE_BASE_SPEED}"
BRIDGE_MAX_ANGULAR_Z="${RK_GO2_BRIDGE_MAX_ANGULAR_Z:-1.10}"
